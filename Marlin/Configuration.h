...
#define STRING_CONFIG_H_AUTHOR "Hulligan/" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Blue Balls"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 32, -10, -1 }
